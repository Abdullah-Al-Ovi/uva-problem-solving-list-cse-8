                ...
                <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center">
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <div className="mt-8 flex flex-wrap justify-center gap-4">
                                ...
                                <Link to='/submission-list' className="relative inline-flex items-center px-12 py-3 overflow-hidden text-lg font-medium text-gray-300 border-2 border-indigo-600 rounded-full hover:text-white group hover:bg-gray-50">
