...
const Rank = ({ submissionCounts,problemIds }) => {
...
const RankPage = () => {
    ...
    const users = [
        ...
        { userId: "1345019", roll: "21CSE029", name: "Md. Ataur Rahman Osman Goni"},
    ...
    return (
        <div className="w-full">
            <Rank problemIds={problemIds} submissionCounts={submissionCounts} />
        </div>
    );
};
